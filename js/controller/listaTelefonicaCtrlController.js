angular
    ...
    .controller("listaTelefonicaCtrl", ($scope, $http, $filter, contatosAPI) => {
        ...
        var formatarPaises = () => {
            $scope.names.map((pais) => {
                pais.name = pais.name + ' (' + pais.dial_code + ')';
                return pais;
            })
        }
        ...
        $scope.LoadSessionData = function(nomePaisSelecionado) {
            ...
            $scope.paisSelecionado = $scope.names.find((pais) => {
                if (pais.name === nomePaisSelecionado) return pais;
            });

            if ($scope.paisSelecionado !== undefined) {
                $scope.selecionarPais = $scope.paisSelecionado.dial_code;
            }
        }
